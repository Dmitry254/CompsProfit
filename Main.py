...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.add_img = tk.PhotoImage(file='D:\\CompsProfit\\images\\add.png')
        ...
        self.edit_img = tk.PhotoImage(file='D:\\CompsProfit\\images\\edit.png')
        ...
        self.delete_img = tk.PhotoImage(file='D:\\CompsProfit\\images\\delete.png')
    ...
    def results(self):
        ...
        self.total_per_day = ("%.2f" % (self.total_profit/self.total_days))

        self.results_string = 'Итого за %s дня заработано %s рублей.\nВ сутки это %s рублей' % (
                                self.total_days, self.total_profit, self.total_per_day)
